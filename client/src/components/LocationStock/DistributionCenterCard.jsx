...
import { deleteCenter } from '../../redux/locationReducer/locationActions';
    ...
    <div className="distributionCenterCardContainer">
      ...
      <div className="dropdown">
        ...
        <div className={`dropdown-content-${activeToggle}`}>
          <div onClick={seeMap}>
            <p className="seeMap">Ver en mapa</p>
          </div>
          <div onClick={modifyLocation}>
            <p className="modifyLocation">Modificar</p>
          </div>
      ...
      <Modal open={modifyForm} onClose={handleClose} className={classes.modal}>
        <div className="modalMapContent">
          {<ModifyLocationForm closeModal={handleClose} center={center} />}
        </div>
      </Modal>
    </div>
  );
