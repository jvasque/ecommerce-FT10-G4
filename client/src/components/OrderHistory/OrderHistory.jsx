  ...
  return (
    <div className="containerOrderHistory">
      <div className="containerFilterOrder">
        ...
        <div className="stateFilter" onClick={sortState}>
          <DivText content="Estado" />
        </div>
        <div className="creationFilter" onClick={sortCreation}>
          <DivText content="Fecha de apertura" />
        </div>
        <div className="updateFilter" onClick={sortUpdate}>
          <DivText content="Fecha de compra" />
        </div>
        <div className="paymentFilter" onClick={sortPayment}>
          <DivText content="Metodo de Pago" />
        </div>
        <div className="totalFilter" onClick={sortTotal}>
      ...
      {orders.length === 0 && (
        <div className="defaultResponse">
          <div>
            <img
              alt="worriedFace"
              src="https://uc-emoji.azureedge.net/orig/47/90802f22bc41a90fbf94350661ae06.png"
              width="150"
              height="150"
            />
          </div>
          <h4>
            ¡Todavía no tenés <strong>órdenes de compra</strong>!
          </h4>
        </div>
      )}
    </div>
